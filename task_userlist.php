        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-md-offset-4">
              <h2>My Opportunities Search</h2>
                <form action="task_userlist.php" method="post">
          ...
          <div class="row">
            <?php
                ...
                if($_POST["submit"]=="search"){
                    ...
                    $select_query = "SELECT a.id, a.taskdomainid, a.taskname, a.description, a.onlineflag, a.activeflag, a.start, a.finish, a.location, b.description AS taskdescription "
                                            ." FROM task a, taskdomain b WHERE a.taskdomainid=b.id AND a.userid = $s_userid "; 
