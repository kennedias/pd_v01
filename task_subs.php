        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-md-offset-4">
              <h2>Opportunities Subscribed</h2>
                <form action="task_subs.php" method="post">
          ...
          <div class="row">
            <?php
                ...
                if($_POST["submit"]=="search"){
                    ...
                    $select_query = "SELECT a.id, a.taskdomainid, a.userid, a.taskname, a.description, a.onlineflag, a.activeflag, a.start, a.finish, a.location, b.description AS taskdescription, c.username, d.date_subs "
                                            ." FROM task a, taskdomain b, user c, tasksubs d WHERE a.taskdomainid=b.id AND a.userid = c.id AND a.id = d.taskid AND d.userid = $s_userid ";                        
                                ...
                                foreach ($connection->query($select_query) as $row){
                                    ...
                                    echo "<article class='search-result row'>";
                                        ...
                                        echo "<div class='col-xs-12 col-sm-12 col-md-5 excerpet'>";
                                            echo "<h3><a href='task_manager.php?taskid=$id' title=''>$taskname</a></h3>";
                                            if($activeflagvalue){
                                            ...
                                            echo "</br>";
                                            echo "<label for='subscription_date'>Subscribed data: $subs_date</label>";
                                            echo "</br>";
